...
with tab_bh_wcs:
    ...
    if up_dx and up_ct:
        ...
        # LỌC TRỰC TIẾP TỪ FILE CHI TIẾT (LẤY TẤT CẢ DÒNG BẢO HÀNH W)
        ...
        with c_filter1:
            opt_filter = st.selectbox("📌 Lọc phạm vi lệnh bảo hành:", ["Tất cả lệnh bảo hành (W)", "Chỉ lấy dòng Đã đóng"], index=0)
